...
import type { FormDraft, FormSchema, WizardStep, FormAnswers } from '@/types/form-schema';
...
export const useWizardStore = create<WizardState>()((set) => ({
  ...
  restoreDraft: (draft) =>
    set({
      ...
      currentStep: Math.min(Math.max(draft.currentStep, 2), 3) as WizardStep,
    }),
