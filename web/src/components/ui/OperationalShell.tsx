...
export function OperationalShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className={`min-h-screen transition-colors duration-700 ${themeClass}`}>
      ...
      <div
        className={`theme-sidebar fixed inset-y-0 left-0 z-50 w-[18.5rem] max-w-[88vw] transform border-r backdrop-blur-xl transition-transform duration-300 lg:hidden ${
