...
Se o GLPI estiver indisponivel e nao houver identidade cacheada, bloqueia com 503.
"""
import logging
import time
import hashlib
...
async def verify_session(
    ...
    4. Se GLPI indisponível e não houver cache → bloqueia com 503
    ...
    Raises:
        ...
        HTTPException 503 se o GLPI estiver indisponivel sem identidade cacheada
    """
    ...
    try:
        ...
        # GLPI indisponível: sem cache compartilhado, nao ha como validar o usuario.
        elapsed_ms = (time.perf_counter() - started_at) * 1000
        _log.warning(
